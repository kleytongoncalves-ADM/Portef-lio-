# Obras e Facilities — modelo para Google Planilhas

Este pacote deriva das planilhas fornecidas e conserva suas matrizes, abas, fórmulas, cores, validações e painéis. Os dados institucionais foram substituídos por 5 contratos fictícios. Para usar, siga **INSTALACAO-PT.md**. Os XLSX são arquivos de transporte; não são versões funcionais independentes para Excel.

## Componentes

| Chave no instalador | Arquivo | Uso |
| --- | --- | --- |
| `extra` | MODELO-PUBLICO-FACILITIES-EXTRA.xlsx | Lançamentos mensais e conexão temática |
| `op` | MODELO-PUBLICO-FACILITIES-OP.xlsx | Vigências, pagamentos, aditivos e saldos |
| `aux` | MODELO-PUBLICO-FACILITIES-AUX.xlsx | Normalização, vínculos, cálculos e validação |
| `dash` | MODELO-PUBLICO-FACILITIES-DASH.xlsx | Painéis, consultas e 14 gráficos do arquivo de referência |
...
Com os exemplos e após todas as conexões: o painel contratual deve mostrar valor original **R$ 240.000,00**, com aditivo **R$ 241.200,00** e saldo atual agregado **R$ 128.400,00**. O total de serviço lançado nos seis meses de exemplo é **R$ 120.000,00**. O primeiro contrato tem saldo de serviço **R$ 13.200,00** e saldo projetado de serviço **R$ 1,200,00**, portanto sem risco.
