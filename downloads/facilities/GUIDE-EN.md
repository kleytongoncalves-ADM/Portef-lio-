# Obras e Facilities — Google Sheets template package

This package retains the supplied workbook layouts, monthly matrices, formulas, validation rules and dashboards, with 5 fictional contracts. XLSX files are transport files for Google Sheets; they are not standalone Excel systems. Follow **INSTALLATION-EN.md** and use **manifesto-modelos.json**.
...
Native Google Sheets spot checks confirmed original contract amount BRL 240,000.00, amended amount BRL 241,200.00, combined current balance BRL 128,400.00 and six-month service entries BRL 120,000.00. The first contract's service balance is BRL 13,200.00; its projected balance is positive BRL 1,200.00.
